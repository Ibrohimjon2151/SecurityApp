...
public class CategoryController {
    ...
    @PostMapping
    public HttpEntity<ApiResponce> addElement(@RequestBody Category category){
    ...
    @PutMapping("/{id}")
    public HttpEntity<ApiResponce> edite(@RequestParam Integer id , @RequestBody Category category){
