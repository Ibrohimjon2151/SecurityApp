...
public class ProductController {
    ...
    @PostMapping
    public HttpEntity<ApiResponce> addElement(@RequestBody ProductDTO category){
    ...
    @PutMapping("/{id}")
    public HttpEntity<ApiResponce> edite(@RequestParam Integer id , @RequestBody ProductDTO category){
